...
.. code-block:: bash
        ...
        curl -sk -u admin:password -X POST https://<bigip>/mgmt/tm/asm/policies -d '{"name":"curl1"}' | sed 's/,/\'$'\n/g'
...
Notice the policy was not applied, click "Apply Policy", this is a separate command.
